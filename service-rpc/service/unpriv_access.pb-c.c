...
{
	static const GetRandomBytesFullTimeoutRequest init_value =
...
{
	assert(message->base.descriptor ==
	       &get_random_bytes_full_timeout_request__descriptor);
	return protobuf_c_message_get_packed_size(
		(const ProtobufCMessage *)(message));
}
size_t get_random_bytes_full_timeout_request__pack(
	const GetRandomBytesFullTimeoutRequest *message, uint8_t *out)
{
	assert(message->base.descriptor ==
	       &get_random_bytes_full_timeout_request__descriptor);
	return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
...
get_random_bytes_full_timeout_request__unpack(ProtobufCAllocator *allocator,
					      size_t len, const uint8_t *data)
{
	return (GetRandomBytesFullTimeoutRequest *)protobuf_c_message_unpack(
		&get_random_bytes_full_timeout_request__descriptor, allocator,
		len, data);
}
...
{
	static const GetRandomBytesFullTimeoutResponse init_value =
...
{
	assert(message->base.descriptor ==
	       &get_random_bytes_full_timeout_response__descriptor);
	return protobuf_c_message_get_packed_size(
		(const ProtobufCMessage *)(message));
}
size_t get_random_bytes_full_timeout_response__pack(
	const GetRandomBytesFullTimeoutResponse *message, uint8_t *out)
{
	assert(message->base.descriptor ==
	       &get_random_bytes_full_timeout_response__descriptor);
	return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
...
get_random_bytes_full_timeout_response__unpack(ProtobufCAllocator *allocator,
					       size_t len, const uint8_t *data)
{
	return (GetRandomBytesFullTimeoutResponse *)protobuf_c_message_unpack(
		&get_random_bytes_full_timeout_response__descriptor, allocator,
		len, data);
}
...
static const ProtobufCFieldDescriptor
	get_random_bytes_full_timeout_request__field_descriptors[3] = {
		{
			"len", 1, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_UINT64,
			0, /* quantifier_offset */
			offsetof(GetRandomBytesFullTimeoutRequest, len), NULL,
			NULL, 0, /* flags */
			0, NULL, NULL /* reserved1,reserved2, etc */
		},
		{
			"tv_sec", 2, PROTOBUF_C_LABEL_NONE,
		...
		{
			"tv_nsec", 3, PROTOBUF_C_LABEL_NONE,
			PROTOBUF_C_TYPE_UINT32, 0, /* quantifier_offset */
...
static const ProtobufCIntRange
	get_random_bytes_full_timeout_request__number_ranges[1 + 1] = {
		{ 1, 0 },
		{ 0, 3 }
	};
const ProtobufCMessageDescriptor
	get_random_bytes_full_timeout_request__descriptor = {
		...
		get_random_bytes_full_timeout_request__field_indices_by_name,
		1,
		get_random_bytes_full_timeout_request__number_ranges,
...
static const ProtobufCFieldDescriptor
	get_random_bytes_full_timeout_response__field_descriptors[2] = {
		{
			"ret", 1, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_INT64,
			0, /* quantifier_offset */
			offsetof(GetRandomBytesFullTimeoutResponse, ret), NULL,
			NULL, 0, /* flags */
			0, NULL, NULL /* reserved1,reserved2, etc */
		},
		{
...
static const ProtobufCIntRange
	get_random_bytes_full_timeout_response__number_ranges[1 + 1] = {
		{ 1, 0 },
		{ 0, 2 }
	};
const ProtobufCMessageDescriptor
	get_random_bytes_full_timeout_response__descriptor = {
		...
		get_random_bytes_full_timeout_response__field_indices_by_name,
		1,
		get_random_bytes_full_timeout_response__number_ranges,
		(ProtobufCMessageInit)
			get_random_bytes_full_timeout_response__init,
		NULL,
		NULL,
...
static const ProtobufCMethodDescriptor unpriv_access__method_descriptors[15] = {
	...
	{ "RpcGetEntLvl", &get_ent_lvl_request__descriptor,
	  &get_ent_lvl_response__descriptor },
	{ "RpcIsMinSeeded", &is_min_seeded_request__descriptor,
	  &is_min_seeded_response__descriptor },
	{ "RpcIsFullySeeded", &is_fully_seeded_request__descriptor,
	  &is_fully_seeded_response__descriptor },
	{ "RpcGetRandomBytesFull", &get_random_bytes_full_request__descriptor,
	  &get_random_bytes_full_response__descriptor },
	{ "RpcGetRandomBytesFullTimeout",
	  &get_random_bytes_full_timeout_request__descriptor,
	  &get_random_bytes_full_timeout_response__descriptor },
...
void unpriv_access__rpc_get_random_bytes_full_timeout(
