...
void jent_status_request__init(JentStatusRequest *message)
{
	static const JentStatusRequest init_value = JENT_STATUS_REQUEST__INIT;
	*message = init_value;
}
size_t jent_status_request__get_packed_size(const JentStatusRequest *message)
{
	assert(message->base.descriptor == &jent_status_request__descriptor);
	return protobuf_c_message_get_packed_size(
		(const ProtobufCMessage *)(message));
}
size_t jent_status_request__pack(const JentStatusRequest *message, uint8_t *out)
{
	assert(message->base.descriptor == &jent_status_request__descriptor);
	return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
}
size_t jent_status_request__pack_to_buffer(const JentStatusRequest *message,
					   ProtobufCBuffer *buffer)
{
	assert(message->base.descriptor == &jent_status_request__descriptor);
	return protobuf_c_message_pack_to_buffer(
...
JentStatusRequest *jent_status_request__unpack(ProtobufCAllocator *allocator,
					       size_t len, const uint8_t *data)
{
	return (JentStatusRequest *)protobuf_c_message_unpack(
		&jent_status_request__descriptor, allocator, len, data);
}
void jent_status_request__free_unpacked(JentStatusRequest *message,
					ProtobufCAllocator *allocator)
{
	if (!message)
		return;
...
void jent_status_response__init(JentStatusResponse *message)
{
	static const JentStatusResponse init_value = JENT_STATUS_RESPONSE__INIT;
	*message = init_value;
}
size_t jent_status_response__get_packed_size(const JentStatusResponse *message)
{
	assert(message->base.descriptor == &jent_status_response__descriptor);
	return protobuf_c_message_get_packed_size(
		(const ProtobufCMessage *)(message));
}
size_t jent_status_response__pack(const JentStatusResponse *message,
				  uint8_t *out)
{
	assert(message->base.descriptor == &jent_status_response__descriptor);
	return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
}
size_t jent_status_response__pack_to_buffer(const JentStatusResponse *message,
					    ProtobufCBuffer *buffer)
{
	assert(message->base.descriptor == &jent_status_response__descriptor);
	return protobuf_c_message_pack_to_buffer(
...
JentStatusResponse *jent_status_response__unpack(ProtobufCAllocator *allocator,
						 size_t len,
						 const uint8_t *data)
{
	return (JentStatusResponse *)protobuf_c_message_unpack(
		&jent_status_response__descriptor, allocator, len, data);
}
void jent_status_response__free_unpacked(JentStatusResponse *message,
					 ProtobufCAllocator *allocator)
{
	if (!message)
		return;
...
static const ProtobufCFieldDescriptor
	jent_status_request__field_descriptors[1] = {
		{
			"maxlen", 1, PROTOBUF_C_LABEL_NONE,
			PROTOBUF_C_TYPE_UINT32, 0, /* quantifier_offset */
			offsetof(JentStatusRequest, maxlen), NULL, NULL,
			0, /* flags */
			0, NULL, NULL /* reserved1,reserved2, etc */
		},
	};
...
const ProtobufCMessageDescriptor jent_status_request__descriptor = {
	...
	1,
	jent_status_request__number_ranges,
...
static const ProtobufCFieldDescriptor
	jent_status_response__field_descriptors[2] = {
		{
			"ret", 1, PROTOBUF_C_LABEL_NONE, PROTOBUF_C_TYPE_INT32,
			0, /* quantifier_offset */
			offsetof(JentStatusResponse, ret), NULL, NULL,
			0, /* flags */
			0, NULL, NULL /* reserved1,reserved2, etc */
		},
		{
			"buffer", 2, PROTOBUF_C_LABEL_NONE,
			PROTOBUF_C_TYPE_STRING, 0, /* quantifier_offset */
			offsetof(JentStatusResponse, buffer), NULL,
			&protobuf_c_empty_string, 0, /* flags */
			0, NULL, NULL /* reserved1,reserved2, etc */
		},
	};
...
const ProtobufCMessageDescriptor jent_status_response__descriptor = {
	...
	1,
	jent_status_response__number_ranges,
...
static const ProtobufCMethodDescriptor unpriv_access__method_descriptors[13] = {
	...
	{ "RpcGetMinReseedSecs", &get_min_reseed_secs_request__descriptor,
	  &get_min_reseed_secs_response__descriptor },
	{ "RpcJentStatus", &jent_status_request__descriptor,
	  &jent_status_response__descriptor },
};
