...
#define STATUS_REQUEST__INIT                                                   \
	{ PROTOBUF_C_MESSAGE_INIT(&status_request__descriptor), 0 }
...
#define STATUS_RESPONSE__INIT                                                  \
	{ PROTOBUF_C_MESSAGE_INIT(&status_response__descriptor), 0,            \
...
#define JENT_STATUS_REQUEST__INIT                                              \
	{ PROTOBUF_C_MESSAGE_INIT(&jent_status_request__descriptor), 0 }
...
#define JENT_STATUS_RESPONSE__INIT                                             \
	{ PROTOBUF_C_MESSAGE_INIT(&jent_status_response__descriptor), 0,       \
	  (char *)protobuf_c_empty_string }
...
#define GET_ENT_LVL_RESPONSE__INIT                                             \
	{ PROTOBUF_C_MESSAGE_INIT(&get_ent_lvl_response__descriptor), 0, 0 }
...
#define IS_FULLY_SEEDED_RESPONSE__INIT                                         \
	{ PROTOBUF_C_MESSAGE_INIT(&is_fully_seeded_response__descriptor), 0, 0 }
...
#define GET_RANDOM_BYTES_PR_REQUEST__INIT                                      \
	{ PROTOBUF_C_MESSAGE_INIT(&get_random_bytes_pr_request__descriptor), 0 }
...
#define GET_SEED_REQUEST__INIT                                                 \
	{ PROTOBUF_C_MESSAGE_INIT(&get_seed_request__descriptor), 0, 0 }
...
#define GET_RANDOM_BYTES_REQUEST__INIT                                         \
	{ PROTOBUF_C_MESSAGE_INIT(&get_random_bytes_request__descriptor), 0 }
...
#define WRITE_DATA_RESPONSE__INIT                                              \
	{ PROTOBUF_C_MESSAGE_INIT(&write_data_response__descriptor), 0 }
...
#define RND_GET_ENT_CNT_RESPONSE__INIT                                         \
	{ PROTOBUF_C_MESSAGE_INIT(&rnd_get_ent_cnt_response__descriptor), 0, 0 }
...
#define GET_POOLSIZE_RESPONSE__INIT                                            \
	{ PROTOBUF_C_MESSAGE_INIT(&get_poolsize_response__descriptor), 0, 0 }
...
size_t jent_status_request__pack(const JentStatusRequest *message,
				 uint8_t *out);
...
typedef void (*StatusResponse_Closure)(const StatusResponse *message,
				       void *closure_data);
typedef void (*JentStatusRequest_Closure)(const JentStatusRequest *message,
					  void *closure_data);
typedef void (*JentStatusResponse_Closure)(const JentStatusResponse *message,
					   void *closure_data);
typedef void (*GetEntLvlRequest_Closure)(const GetEntLvlRequest *message,
					 void *closure_data);
typedef void (*GetEntLvlResponse_Closure)(const GetEntLvlResponse *message,
					  void *closure_data);
typedef void (*IsFullySeededRequest_Closure)(
	const IsFullySeededRequest *message, void *closure_data);
typedef void (*IsFullySeededResponse_Closure)(
	const IsFullySeededResponse *message, void *closure_data);
