...
typedef struct GetRandomBytesFullTimeoutResponse
...
#define IS_MIN_SEEDED_RESPONSE__INIT                                           \
	{ PROTOBUF_C_MESSAGE_INIT(&is_min_seeded_response__descriptor), 0, 0 }
...
size_t
is_min_seeded_request__get_packed_size(const IsMinSeededRequest *message);
...
typedef void (*GetEntLvlResponse_Closure)(const GetEntLvlResponse *message,
					  void *closure_data);
typedef void (*IsMinSeededRequest_Closure)(const IsMinSeededRequest *message,
					   void *closure_data);
typedef void (*IsMinSeededResponse_Closure)(const IsMinSeededResponse *message,
					    void *closure_data);
...
typedef void (*GetRandomBytesFullTimeoutRequest_Closure)(
	const GetRandomBytesFullTimeoutRequest *message, void *closure_data);
typedef void (*GetRandomBytesFullTimeoutResponse_Closure)(
	const GetRandomBytesFullTimeoutResponse *message, void *closure_data);
...
struct UnprivAccess_Service {
	...
	void (*rpc_get_random_bytes_full_timeout)(
		UnprivAccess_Service *service,
