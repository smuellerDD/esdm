...
typedef struct JentStatusRequest JentStatusRequest;
...
/*
 **
 * @brief Request to get Jitterentropy status
 * @param maxlen Maximum size of buffer
 */
struct  JentStatusRequest
{
  ProtobufCMessage base;
  uint32_t maxlen;
};
#define JENT_STATUS_REQUEST__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&jent_status_request__descriptor) \
, 0 }
 ...
 * @param buffer Buffer with ASCII status - this is a NULL-terminated string
 */
struct  JentStatusResponse
{
  ProtobufCMessage base;
  int32_t ret;
  char *buffer;
};
#define JENT_STATUS_RESPONSE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&jent_status_response__descriptor) \
, 0, (char *)protobuf_c_empty_string }
 ...
 */
struct  GetEntLvlRequest
{
  ProtobufCMessage base;
};
#define GET_ENT_LVL_REQUEST__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&get_ent_lvl_request__descriptor) \
 }
 ...
 */
struct  GetEntLvlResponse
{
  ProtobufCMessage base;
  int32_t ret;
  uint32_t entlvl;
};
#define GET_ENT_LVL_RESPONSE__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&get_ent_lvl_response__descriptor) \
, 0, 0 }
...
#define IS_FULLY_SEEDED_REQUEST__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&is_fully_seeded_request__descriptor) \
 }
...
typedef void (*StatusResponse_Closure)
                 (const StatusResponse *message,
                  void *closure_data);
typedef void (*JentStatusRequest_Closure)
                 (const JentStatusRequest *message,
                  void *closure_data);
typedef void (*JentStatusResponse_Closure)
                 (const JentStatusResponse *message,
                  void *closure_data);
typedef void (*GetEntLvlRequest_Closure)
                 (const GetEntLvlRequest *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor jent_status_request__descriptor;
